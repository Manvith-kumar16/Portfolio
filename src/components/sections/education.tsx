      ...
      <div className="space-y-6 px-4 md:px-8 max-w-5xl mx-auto">
        {EDUCATION.map((edu, idx) => (
          ...
          >
            ...
            {/* Icon Container */}
            <div className="relative z-10 flex items-center justify-center w-16 h-16 md:w-20 md:h-20 rounded-full bg-white/5 border border-white/10 shadow-inner group-hover:scale-110 group-hover:bg-blue-500/10 transition-all duration-500 shrink-0">
              {edu.icon}
            </div>
